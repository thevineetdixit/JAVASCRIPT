...
1.innerHTML  // jo bhi likha h tag ke andar (including tags) wo dikha dega

2.textContent  // jo bhi text context h,jo ki visibe h ya nhi bhi wo dikha dega


3.innerText  // jo content visible h screen pr sirf wahi dikhayega
